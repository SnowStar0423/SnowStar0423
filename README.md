...
[![My Skills](https://skillicons.dev/icons?i=flutter,android,ios,swift,java,aws,vue,dart,css,html,git,github,gitlab,docker,go,grafana,graphql,js,laravel,nestjs,nginx,nodejs,nuxtjs,php,postgres,prometheus,svelte,tailwind,ts,vscode&perline=12)](https://skillicons.dev)
